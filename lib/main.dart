  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      onGenerateRoute: (settings) {
        ...
        if (uri.pathSegments.length == 3 && uri.pathSegments[0] == 'wettkampf') {
...
//                builder: (_) => const Dankeschoen(titel: 'Sporttag - Vorab - Anmeldung'));
          ...
          case 'riegenEinteilung':
            return MaterialPageRoute(builder: (_) => const RiegenEinteilung(titel: 'Riegen einteilen'));
          case 'riegenZuordnung':
            return MaterialPageRoute(builder: (_) => const RiegenZuordnung(titel: 'Riegen den Riegenführern zuordnen'));
          case 'auswertung':
...
/***********************************************
 * ältere Version, die noch nicht mit dem neuen Parse Server funktioniert
 */
// import 'package:flutter/material.dart';
// import 'package:logger/logger.dart';
// import 'package:sporttag/src/riegen_zuordnung.dart';
...
//         'vorabAnmeldung': (context) =>  const AnmeldenVorher(title: 'Sporttag - Vorab - Anmeldung'),
...
//         'dankeschoen': (context) =>  const Dankeschoen(titel: 'Sporttag - Vorab - Anmeldung') ,
//       },
//     );
//   }
// }
